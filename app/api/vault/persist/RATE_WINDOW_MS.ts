...
function validatePayload(body: unknown): ValidationResult {
    ...
    const numericChecks: [string, number, number][] = [
        ["ghost_tax_annual", -1, 100000000],
        ["ghost_tax_low", -1, 100000000],
        ["ghost_tax_high", -1, 100000000],
        ["entropy_score", -1, 101],
        ["entropy_kappa", -0.01, 1],
        ["peer_percentile", -1, 101],
        ["audit_roi", -100, 10000],
        ["recoverable_annual", -1, 100000000],
        ["headcount", 0, 100000],
        ["saas_tool_count", 0, 10000],
        ["monthly_spend_saas", -1, 50000000],
        ["monthly_spend_cloud", -1, 50000000],
        ["monthly_spend_ai", -1, 50000000],
        ["monthly_spend_total", -1, 100000000],
    ];
