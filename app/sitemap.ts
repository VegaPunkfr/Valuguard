...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    // Intelligence index
    { url: `${BASE}/intel-benchmarks`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/intel-benchmarks/saas-ai-cost-exposure`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/intel-benchmarks/shadow-ai-governance`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/intel-benchmarks/cfo-technology-spend-guide`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
