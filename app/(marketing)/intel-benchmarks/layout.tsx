...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "53% of SaaS licenses go unused (Zylo 2025). Average mid-market company wastes €28k–€180k/yr on ghost spend. Industry benchmarks from Gartner, Flexera, and Zylo 2025 reports.",
