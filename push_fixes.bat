...
echo Staging des fichiers valides...
...
git commit -m "fix: TypeScript build errors — duplicate border props + restore truncated backend files"
...
echo  ghost-tax.com/command      Mission Control v5 (dark cockpit unifie)
